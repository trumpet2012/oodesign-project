...
public class CreditReport {
	...
	private MoBettaScanner latePay = new MoBettaScanner("You indicated you have " + this.RECENT_LATE_PAYMENT_NUMBER+" late payments on record.\n"
	...
	private int calcPaymentHistoryScore(){
		...
		case(1): severity = 1;
			break;
		case(3): case(2): severity = 2.5;
			break;
		case(5): case(4): severity = 5;
			break;
		default: severity = 10;
		}
